        ...
        <Card className="glass-card border-0 shadow-2xl">
          <Tabs defaultValue="login" className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-4">
              ...
              <TabsTrigger value="signup">{language === 'ar' ? 'إنشاء حساب' : 'Sign Up'}</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="signup">
              <CardHeader className="pb-4">
                ...
                <CardDescription>
                  {language === 'ar' ? 'إنشاء حساب مدير للنظام' : 'Create an admin account'}
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSignup} className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="signup-name">{language === 'ar' ? 'الاسم بالكامل' : 'Full Name'}</Label>
                    <div className="relative">
                  ...
                  <Button type="submit" className="w-full" disabled={isLoading}>
                    {isLoading 
                      ? (language === 'ar' ? "جارٍ الإنشاء..." : "Signing up...") 
